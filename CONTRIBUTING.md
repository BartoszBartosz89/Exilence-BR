...
1. Search [GitHub](https://github.com/BartoszBartosz89/Exilence-BR/pulls) for an open or closed PR that relates to your submission before creating a new one.
1. Be sure that an issue describes the problem you're fixing.
1. Fork the BartoszBartosz89/Exilence-BR repo.
...
4. Translate everything. We use react-i18next for translating, keys should be added in suiting namespace in [/public/i18n](https://github.com/BartoszBartosz89/Exilence-BR/tree/master/public/i18n/en). If a suiting namespace does not exist, feel free to create one (needs to be included in the [config](https://github.com/BartoszBartosz89/Exilence-BR/blob/master/src/config/i18n.ts)).
